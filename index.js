...
favoriteMovie.quote = "How you doin?"
...
console.log(greeting + ' I am ' + age + " my favorite movie is " + favoriteMovie.name + " I rate the movie a " + favoriteMovie.rating + " and the genre is " + favoriteMovie.genre + " my favorite quote from the movie is " + favoriteMovie.quote)